  ...
  return (
    <div className="min-h-screen bg-amber-50 px-4 sm:px-8 md:px-16 lg:px-24 py-16">
      <div className="max-w-7xl mx-auto space-y-12">
        <h1 className="text-4xl font-bold text-yellow-600 border-b-4 border-amber-200 pb-4">
          About Hansraj Industries
        </h1>

        {/* About & Quick Facts */}
        <div className="space-y-10">
          <div className="bg-white border border-emerald-200 shadow p-6 space-y-6 rounded-xl">
          ...
          <div className="bg-white border border-emerald-200 shadow p-6 rounded-xl">
            <h2 className="text-xl font-semibold text-sky-900 mb-4">Quick Facts</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-white border border-emerald-200 shadow p-6 rounded-xl">
            <h2 className="text-xl font-semibold text-sky-900 mb-4">Our Mission</h2>
            <p className="text-slate-700 leading-relaxed">
          ...
          <div className="bg-white border border-emerald-200 shadow p-6 rounded-xl">
            <h2 className="text-xl font-semibold text-sky-900 mb-4">Our Vision</h2>
            <p className="text-slate-700 leading-relaxed">
        ...
        {/* Address */}
        <div className="bg-white border border-emerald-200 shadow p-6 rounded-xl">
          <h2 className="text-xl font-semibold text-sky-900 mb-4">Address</h2>
          ...
          <a
            ...
            className="inline-block mt-4 bg-emerald-600 text-white px-4 py-2 rounded-md hover:bg-emerald-700 transition"
          >
            Get Directions
          </a>
        </div>
        ...
        {/* Highlights */}
        <div className="py-12">
          <h2 className="text-2xl font-bold text-sky-900 mb-8">Our Highlights</h2>
        ...
        {/* Photo Gallery */}
        <div className="py-12">
          <h2 className="text-2xl font-bold text-sky-900 mb-8">Photo Gallery</h2>
        ...
        {/* Contact Us */}
        <div className="bg-white border border-emerald-200 shadow p-6 rounded-xl">
          <h2 className="text-xl font-semibold text-sky-900 mb-4">Tell us what you need, and we'll help you get quotes</h2>
          <button
        ...
        {showPrompt && (
          <div className="fixed inset-0 bg-opacity-40 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-xl border border-amber-200 relative">
              ...
              <h3 className="text-lg font-semibold text-yellow-600 mb-4">Choose Product & Quantity</h3>
              <input
                type="text"
